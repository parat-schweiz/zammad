...
Setting.create_if_not_exists(
  ...
  preferences: {
    ...
    title_i18n:       [__('Quaestur')],
    description_i18n: [__('Quaestur'), __('Quaestur'), 'https://quaestur.parat.swiss'],
    permission:       ['admin.security'],
  },
  state:       false,
  frontend:    true
...
Setting.create_if_not_exists(
  title:       __('Quaestur App Credentials'),
  name:        'auth_oauth2_credentials',
  area:        'Security::ThirdPartyAuthentication::Quaestur',
  description: __('Enables user authentication via Quaestur.'),
  options:     {
    form: [
      {
        display: __('Client ID'),
